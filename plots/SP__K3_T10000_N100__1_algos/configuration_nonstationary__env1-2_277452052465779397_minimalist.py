# -*- coding: utf-8 -*-
"""Minimalist file to reproduce experiments with hash = env1-2_277452052465779397."""
...
# use it with:
# $ python main.py plots/SP__K3_T10000_N100__1_algos/configuration_nonstationary__env1-2_277452052465779397_minimalist.py
